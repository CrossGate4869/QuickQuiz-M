...
3. 保存输入的密码，保存期限为7天。
4. 添加新题库《安全规程电气部分》，权限为公开。
5. 添加新题库《安全管理复审换证题库》，权限为加密。
...
1. 修订《安全环保知识答题》《党政工知识答题》《学习强国题库》。
2. 为所有输入框添加点击全选功能。

## 2020/12/15提交修改V1.01

1. 新增题库《危化品取证题库》《危化品复审题库》权限为公开。
